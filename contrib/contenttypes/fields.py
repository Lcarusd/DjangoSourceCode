...
class GenericForeignKey(object):
    """
    通过content-type / object-idfields提供与任何对象的通用关系。
    """
    # 字段标志
    auto_created = False
    concrete = False
...
class ReverseGenericRelatedObjectsDescriptor(object):
    """
    该类提供了使相关对象管理器可用作模型类属性的功能，
    用于具有多个“远程”值并且在其模型中定义了GenericRelation
    (而不是让另一个模型指向* at *)的字段。 
    在“article.publications”示例中，
    publications属性是ReverseGenericRelatedObjectsDescriptor实例。
    """
